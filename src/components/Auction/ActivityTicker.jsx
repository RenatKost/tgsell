...
/* в”Ђв”Ђ Custom inline SVG icons в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ */
const IconDeal = () => (
...
const timeAgo = (isoStr) => {
	...
	if (h < 24) return `${h} РіРѕРґ`;
	return `${Math.floor(h / 24)} Рґ`;
};
const cleanText = (text) => text.replace(/^.\s/, '');

/* в”Ђв”Ђ ActivityTicker в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ */
const ActivityTicker = ({ stats }) => {
	...
	/* Side-panel stats: prefer real stats prop, fallback to feed counts */
		...
		<div className='mb-6 relative'>
			...
			>
				...
				<div className='flex items-center justify-between px-4 py-2.5 border-b border-gray-100 dark:border-card-border'>
					...
					<span className='text-xs text-gray-400'>{events.length} РїРѕРґС–Р№</span>
				</div>
							...
							return (
								<div key={key} className={`px-2 py-1.5 rounded-lg bg-gray-50 dark:bg-card-inner border-l-2 ${borderClass}`}>
									<div className='flex items-center justify-between mb-0.5'>
										...
										<motion.span key={value} initial={{ scale: 1.4, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className={`font-black text-xs ${valueClass}`}>
											{value}
										</motion.span>
									</div>
...
/* в”Ђв”Ђ Thin auto-scrolling bottom ticker в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ */
